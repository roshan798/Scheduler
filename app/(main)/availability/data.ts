...
export type DefaultAvailability = {
    monday: Availbility
    tuesday: Availbility
    wednesday: Availbility
    thursday: Availbility
    friday: Availbility
    saturday: Availbility
    sunday: Availbility
    timeGap: number;
}
...
export type DaysOfWeek = typeof daysOfWeek[number]; // "monday" | "tuesday" | "wednesday" | "thursday" | "friday" | "saturday" | "sunday"